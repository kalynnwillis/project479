...
```{r shooting-analysis}
#| fig-cap: "Relationship between free throw shooting and RAPM (colored by 3-point %)"
#| fig-width: 10
#| fig-height: 6
...
This paradox reveals that neither skill alone predicts winning impact, but their combination does. Elite shooters (FT>80%, 3P>35%) likely possess:
