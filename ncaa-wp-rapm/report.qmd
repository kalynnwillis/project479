...
1. **Win Probability Modeling**: Achieved excellent predictive performance (AUC = 0.861 with XGBoost across 7 seasons)
2. **Player Impact Range**: Top players contribute 0.0005-0.0009 additional win probability per possession (equivalent to +3-6% per game) 
