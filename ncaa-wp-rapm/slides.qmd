...
**Source**: ncaahoopR package (2023-24 season)
...
::: incremental
1. **Elite players matter**: Top players add 2-3% WP per possession

2. **Regularization works**: Stable estimates despite sparse data

3. **Minutes ≠ Value**: High-minute players can have negative RAPM

4. **Model agreement**: Ridge, Lasso, Elastic Net highly correlated (r > 0.95)
:::
...
::: incremental
1. **Data quality**: Lineup approximations when exact data unavailable

2. **Sample size**: Few-game players have uncertain estimates

3. **Context missing**: Doesn't capture role, matchups, coaching

4. **Endogeneity**: Good players face tougher opponents
:::
...
::: incremental
- ✅ Rigorous metric for player impact
- ✅ Controls for context (teammates, opponents, teams)  
- ✅ Regularization handles sparse data
- ✅ Direct interpretation (change in WP)
:::

<br>

::: {.fragment}
**Main takeaway**: Player contributions vary substantially, even among starters. Elite players can shift game outcomes by several percentage points per game.
:::
