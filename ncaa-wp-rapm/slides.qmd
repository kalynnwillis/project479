...
::: {.notes}
**Key insight**: Elite two-way shooting is a POWERFUL predictor of top performance, but NOT the only path. It provides a high floor (consistent positive impact) and a pathway to elite status when combined with other skills.
