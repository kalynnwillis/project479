...
- RAPM (raw): `{r} round(top_player$ridge_rapm, 6)` WP/possession
- Games: `{r} top_player$games_played` | Avg Minutes: `{r} round(top_player$avg_minutes, 1)`
...
- **Per Possession**: +`{r} round(top_player$ridge_rapm * 100, 3)`% win probability
- **Per Game Impact**: +`{r} round(top_player$ridge_rapm * 70 * 100, 1)`% win probability
- **Season Impact**: Equivalent to **`{r} round(top_player$ridge_rapm * 70 * top_player$games_played * 100, 1)`%** cumulative WP
- **Wins Above Replacement**: ~`{r} round(top_player$ridge_rapm * 70 * top_player$games_played, 1)` additional wins
:::
